...
###############------------Mouse E16: re-analysis on Vladoiu's scRNA-seq Data-------------------#####################################
...
setwd("C:/Users/ghiyamif/OneDrive - University of Manitoba/eCN_project/Datasets/Vladoiu/E16")

# Load the sparse matrix
expression_matrix <- readMM("GSM3318002_E16_matrix.mtx")

# Load gene names (features)
features <- read.table("GSM3318002_E16_genes.tsv", 
...
barcode_folder <- "GSM3318002_E16_barcodes/"
...
dim(expression_matrix)  # Should be genes x cells: [1] 27998  7383
length(barcodes)        # Should match the number of columns in expression_matrix: [1] 7383
...
saveRDS(seurat_object, file = "S_Object_Vladoiu_E16_raw_FG1.rds")
...
seurat_object <- readRDS("S_Object_Vladoiu_E16_raw_FG1.rds")
...
#Save the seurat object
saveRDS(seurat_object, file = "S_Object_Vladoiu_E16_filtered_FG2.rds")
...
seurat_object <- readRDS("S_Object_Vladoiu_E16_filtered_FG2.rds")

seurat_object <- NormalizeData(seurat_object, normalization.method = "LogNormalize")

saveRDS(seurat_object, file = "S_Object_Vladoiu_E16_normalized_FG3.rds")
...
seurat_object <- readRDS("S_Object_Vladoiu_E16_normalized_FG3.rds")
...
#Save subsetted  eCN_pure as E16_eCN
saveRDS(seurat_object, file = "S_Object_Vladoiu_E16_eCN_FG4.rds")

#####################################################################################################################################
############-------------Step 8: Find variable features and Scale the data

#You can work on the saved normalized data in step 6 (which is a seurat object)
eCN_pure <- readRDS("S_Object_Vladoiu_E16_eCN_FG4.rds")
...
saveRDS(eCN_pure, file = "S_Object_Vladoiu_E16_eCN_clustered_FG5.rds")
# Read the clustered seurat object
eCN_pure <- readRDS("S_Object_Vladoiu_E16_eCN_clustered_FG5.rds")
...
new.cluster.ids <- c("eCN1", "eCN2", "eCN3", "eCN4", "eCN5", "eCN6", "eCN7", "eCN8", "eCN9", "eCN10", "eCN11", "eCN12")
...
write.xlsx(sheets5, file = "E16_markers5.xlsx")
write.xlsx(sheets10, file = "E16_markers10.xlsx")
write.xlsx(sheets20, file = "E16_markers20.xlsx")
write.xlsx(sheets50, file = "E16_markers50.xlsx")
